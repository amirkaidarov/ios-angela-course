...
struct StoryBrain {
    ...
    mutating func nextStory(_ userChoice : String){
        ...
        let isChoiceOne = userChoice == story.choice1
        storyIndex = isChoiceOne ? story.choice1Destination : story.choice2Destination
    }
    ...
    func getStoryChoice(_ number : Int) -> String {
        return number == 1 ? stories[storyIndex].choice1 : stories[storyIndex].choice2
    }
}
